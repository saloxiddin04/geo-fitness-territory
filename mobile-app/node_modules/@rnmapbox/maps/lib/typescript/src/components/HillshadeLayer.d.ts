...
import type { FilterExpression, HillshadeLayerStyleProps } from '../utils/MapboxStyles';
...
declare class HillshadeLayer extends AbstractLayer<Props, NativeTypeProps> {
    static defaultProps: {
        sourceID: any;
    };
...
//# sourceMappingURL=HillshadeLayer.d.ts.map