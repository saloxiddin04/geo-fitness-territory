...
declare enum ModelElevationReferenceEnum {
...
export interface LineLayerStyleProps {
     ...
     * @requires lineZOffset
     */
    lineElevationGroundScale?: Value<number, [
        'zoom',
        'feature',
        'line-progress'
    ]>;
...
export interface ModelLayerStyleProps {
     ...
     */
    modelElevationReference?: Value<Enum<ModelElevationReferenceEnum, ModelElevationReferenceEnumValues>>;
}
...
export type AllLayerStyleProps = FillLayerStyleProps | LineLayerStyleProps | SymbolLayerStyleProps | CircleLayerStyleProps | HeatmapLayerStyleProps | FillExtrusionLayerStyleProps | RasterLayerStyleProps | RasterParticleLayerStyleProps | HillshadeLayerStyleProps | ModelLayerStyleProps | BackgroundLayerStyleProps | SkyLayerStyleProps | LightLayerStyleProps | AtmosphereLayerStyleProps | SnowLayerStyleProps | RainLayerStyleProps | TerrainLayerStyleProps;
export {};
