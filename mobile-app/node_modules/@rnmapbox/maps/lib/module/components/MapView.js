...
import NativeMapViewModule from "../specs/NativeMapViewModule.js";
import { isFunction, isAndroid } from "../utils/index.js";
import { getFilter } from "../utils/filterUtils.js";
import Logger from "../utils/Logger.js";
import NativeBridgeComponent from "./NativeBridgeComponent.js";
...
class MapView extends NativeBridgeComponent(React.PureComponent, NativeMapViewModule) {
  ...
  constructor(props) {
    ...
    this._onDebouncedRegionWillChange = debounce(this._onRegionWillChange.bind(this), props.regionWillChangeDebounceTime, {
      immediate: true
    });
  ...
  async queryRenderedFeaturesInRect(bbox, filter = [], layerIDs = null) {
    if (bbox != null && (bbox.length === 4 || bbox.length === 0)) {
      ...
      throw new Error('Must pass in a valid bounding box: [top, left, bottom, right]. An empty array [] is also acceptable in v10.');
    }
  }
