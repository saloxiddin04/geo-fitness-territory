      ...
      <ScrollView
        ...
        {isNightEvent && (
          <LinearGradient colors={['#1a0a2e', '#2d1b69']} style={styles.nightEventBanner}>
            ...
            <View style={{ marginLeft: 10 }}>
              ...
              <Text style={styles.nightEventText}>XP 1.5x ko'paytiruvchida</Text>
            </View>
          </LinearGradient>
        )}
        ...
        {stats && (
          <View style={styles.statsGrid}>
            <StatCard icon="map-marker-radius" title="Hudud" value={stats.territoriesCount || 0} unit="ta" color="#4CAF50" />
            <StatCard icon="run" title="Masofa" value={((stats.totalDistanceMeters || 0) / 1000).toFixed(1)} unit="km" color="#2196F3" />
            <StatCard icon="eye" title="Ochilgan" value={stats.totalExploredCells || 0} unit="hujayra" color="#FF9800" />
            <StatCard icon="fire" title="Kaloriya" value={Math.round(stats.totalCalories || 0)} unit="kcal" color="#F44336" />
          </View>
        )}
      </ScrollView>
      ...
      <View style={styles.actionsFooter}>
        ...
        <TouchableOpacity
          ...
          <LinearGradient
            ...
            <Icon name={isRunning ? 'stop-circle' : 'run-fast'} size={24} color="#fff" />
...
const styles = StyleSheet.create({
  ...
  startRunButton: { borderRadius: 12, overflow: 'hidden', marginBottom: 10 },
  startRunGradient: {
