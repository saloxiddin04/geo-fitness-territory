...
import { fetchActiveSession } from '../store/slices/runningSlice';
...
const AppNavigator = () => {
  ...
  // App yuklanayotganda tokenni tekshirish va faol sessiyani tiklash
  useEffect(() => {
    dispatch(restoreUser()).then(result => {
